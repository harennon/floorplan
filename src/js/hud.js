 ...
 * Also handles the unit toggle button state.
...
export function init(elZoom, elScale, elCursor, elUnitImp, elUnitMet) {
  _elZoom = elZoom;
  _elScale = elScale;
  _elCursor = elCursor;
 ...
 * Mirrors chooseGridStep logic without importing grid.js.
 */
